...
class result_product_category_money_year:
    def __init__(self):
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('product_category_money_year.txt', 'a', 'utf-8')
    ...
    def case_test(self):
        # os.remove('product_category_money_year.txt')
        _login = login.Login()
        ...
        self.case_1(title=_result_amount.title6, expected=_result_amount.expected6,
...
if __name__ == '__main__':
    _result_amount =result_product_category_money_year()
    os.remove('product_category_money_year.txt')
