...
class result_product_category_money_quarter:
    def __init__(self):
        ...
        self.expected6 = ((['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['81900.0', '81900.0', '245700.0', '163800.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['73800.0', '73800.0', '124200.0', '82800.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['59400.0', '59400.0', '81000.0', '54000.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['23400.0', '23400.0', '70200.0', '46800.0'])
                          )
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            Actual_result =_result.gole_quarter(data1,data2,type='product_category_money',dimension=dimension1)
            test_result=operator.eq(expected[i], Actual_result)
            print (test_result)
            if test_result== True:
                f = codecs.open('product_category_money_quarter.txt', 'a', 'utf-8')
    ...
    def case_test(self):
        os.remove('product_category_money_quarter.txt')
        _login = login.Login()
...
if __name__ == '__main__':
    _result_amount =result_product_category_money_quarter()
    # os.remove('product_category_money_quarter.txt')
