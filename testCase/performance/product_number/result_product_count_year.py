...
class result_product_count_year:
    def __init__(self):
        ...
        self.title5 = 'case5按用户1查看4 5 6季度产品销量'
        ...
        self.title7 = 'case7按用户1查看上半年产品销量'
        ...
        self.title8 = 'case8按用户1查看下半年产品销量'
        ...
        self.title9 = 'case9按用户1查看04--08产品销量'
        ...
        self.title10 = 'case9按用户1查看 7 8 9产品销量'
        ...
        self.title11 = 'case9按用户1查看10 11 12产品销量'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('product_count_year.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_product_count_year()
    # os.remove('product_count_year.txt')
    # 上月
