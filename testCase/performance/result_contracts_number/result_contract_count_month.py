...
class result_contract_count_month:
    def __init__(self):
        ...
        self.title5 = 'case5用户1按月查看4 5 6季度合同数'
        ...
        self.title7 = 'case7用户1按月查看上半年合同数'
        ...
        self.title8 = 'case8用户1按月查看下半年合同数'
        ...
        self.title9 = 'case9用户1按月查看04--08合同数'
        ...
        self.title10 = 'case9用户1按月查看 7 8 9合同数'
        ...
        self.title11 = 'case9用户1按月查看10 11 12合同数'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('contract_count_month.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_contract_count_month()
    os.remove('contract_count_month.txt')
    # 上月
