...
class result_oppptunitites_money_year:
    def __init__(self):
        ...
        self.title1 = 'case1用户1按年查看1月商机金额'
        ...
        self.title2 = 'case2用户1按年查看3月商机金额'
        ...
        self.title3= 'case3用户1按年查看上季度商机金额'
        self.expected3 = (['"设计部子部门-用户4"', '"产品部-用户3"', '"设计部-用户1"', '"主辅部门-用户6"', '"设计部-用户2"', '"销售部-用户5"'],
                          ['', '', '', '', '', ''])
        self.title4 = 'case4用户1按年查看1 2 3季度商机金额'
        ...
        self.title5 = 'case5用户1按年查看4 5 6季度商机金额'
        ...
        self.title6 = 'case6用户1按年查看本年商机金额'
        self.expected6 = ((['2019' ],
                          [ '60186.0']),
                          (['2019'],
                           [ '37836.0']),
        ...
        self.title7 = 'case7用户1按年查看上半年商机金额'
        ...
        self.title8 = 'case8用户1按年查看下半年商机金额'
        ...
        self.title9 = 'case9用户1按年查看04--08商机金额'
        ...
        self.title10 = 'case9用户1按年查看 7 8 9商机金额'
        ...
        self.title11 = 'case9用户1按年查看10 11 12商机金额'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('oppptunitites_money_year.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_oppptunitites_money_year()
    os.remove('oppptunitites_money_year.txt')
    # 上月
