...
class result_win_count_quarter:
    def __init__(self):
        ...
        self.title1 = 'case1用户1按季度查看1月商机数'
        ...
        self.title2 = 'case2用户1按季度查看3月商机数'
        ...
        self.title3= 'case3用户1按季度查看上季度商机数'
        self.expected3 = (['"设计部子部门-用户4"', '"产品部-用户3"', '"设计部-用户1"', '"主辅部门-用户6"', '"设计部-用户2"', '"销售部-用户5"'],
                          ['', '', '', '', '', ''])
        self.title4 = 'case4用户1按季度查看1 2 3季度商机数'
        ...
        self.title5 = 'case5用户1按季度查看4 5 6季度商机数'
        ...
        self.title6 = 'case6用户1按季度查看本年商机数'
        ...
        self.title7 = 'case7用户1按季度查看上半年商机数'
        ...
        self.title8 = 'case8用户1按季度查看下半年商机数'
        ...
        self.title9 = 'case9用户1按季度查看04--08商机数'
        ...
        self.title10 = 'case9用户1按季度查看 7 8 9商机数'
        ...
        self.title11 = 'case9用户1按季度查看10 11 12商机数'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            Actual_result =_result.gole_quarter(data1,data2,type='win_count',dimension=dimension1)
            # print (Actual_result)
            test_result=operator.eq(expected[i], Actual_result)
            print (test_result)
            if test_result== True:
                f = codecs.open('win_count_quarter.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_win_count_quarter()
    # os.remove('win_count_quarter.txt')
    # 上月
