...
from testCase.performance.product_number import result_product_count_number
from testCase.performance.product_number import result_product_count_number_departments
