...
class result_contract_money_year:
    def __init__(self):
        ...
        self.title1 = 'case1用户1按年查看1月合同金额'
        ...
        self.title2 = 'case2用户1按年查看3月合同金额'
        ...
        self.title3= 'case3用户1按年查看上季度合同金额'
        self.expected3 = (['"设计部子部门-用户4"', '"产品部-用户3"', '"设计部-用户1"', '"主辅部门-用户6"', '"设计部-用户2"', '"销售部-用户5"'],
                          ['', '', '', '', '', ''])
        self.title4 = 'case4用户1按年查看1 2 3季度合同金额'
        ...
        self.title5 = 'case5用户1按年查看4 5 6季度合同金额'
        ...
        self.title6 = 'case6用户1按年查看本年合同金额'
        self.expected6 = ((['2019' ],
                          [ '60186.0']),
                          (['2019'],
                           [ '37836.0']),
        ...
        self.title7 = 'case7用户1按年查看上半年合同金额'
        ...
        self.title8 = 'case8用户1按年查看下半年合同金额'
        ...
        self.title9 = 'case9用户1按年查看04--08合同金额'
        ...
        self.title10 = 'case9用户1按年查看 7 8 9合同金额'
        ...
        self.title11 = 'case9用户1按年查看10 11 12合同金额'
...
if __name__ == '__main__':
    _result_amount =result_contract_money_year()
    # os.remove('contract_money_year.txt')
    # 上月
