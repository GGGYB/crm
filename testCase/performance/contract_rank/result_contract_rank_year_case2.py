...
class result_contract_rank_year:
    def __init__(self):
        ...
        self.title3= 'case3按用户1查看上季度合同金额'
        ...
        self.title5 = 'case5按用户1查看4 5 6季度合同金额'
        ...
        self.title6 = 'case6按用户1按年查看本年合同回款金额'
        self.expected6 = ((['2019' ],
                          [ '240240.0']),
                          (['2019'],
                           [ '151200.0']),
        ...
        self.title7 = 'case7按用户1查看上半年合同金额'
        ...
        self.title8 = 'case8按用户1查看下半年合同金额'
        ...
        self.title9 = 'case9按用户1查看04--08合同金额'
        ...
        self.title10 = 'case9按用户1查看 7 8 9合同金额'
        ...
        self.title11 = 'case9按用户1查看10 11 12合同金额'
...
if __name__ == '__main__':
    _result_amount =result_contract_rank_year()
    # os.remove('contract_rank_year.txt')
    # 上月
