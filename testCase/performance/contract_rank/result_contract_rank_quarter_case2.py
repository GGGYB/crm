...
class result_contract_rank_quarter:
    def __init__(self):
        ...
        self.date_list = [['2018-12-01', '2018-12-31'], ['2019-01-01', '2019-01-31'], ['2019-03-01', '2019-03-31'],
                          ['2018-10-01', '2018-12-31'], ['2019-01-01', '2019-03-31'], ['2019-04-01', '2019-06-30'],
                          ['2019-01-1', '2019-12-31'], ['2019-01-01', '2019-06-30'], ['2019-07-01', '2019-12-31'],
                          ['2019-04-01', '2019-08-31'], ['2019-07-01', '2019-09-30'], ['2019-10-01', '2019-12-31']]
        self.title = 'case0用户1按季度查看上月合同回款金额'
        self.expected = ((['"2019一季度"'],
                           ['2869.0']),
                          (['"2019一季度"'],
                           ['1803.0']),
                          (['"2019一季度"'],
        ...
        self.title1 = 'case1用户1按季度查看1月合同回款金额'
        ...
        self.title2 = 'case2按用户1按季度查看3月合同回款金额'
        ...
        self.title3 = 'case3按用户1按季度查看上季度合同回款金额'
        self.expected3 = (['"设计部子部门-用户4"', '"产品部-用户3"', '"设计部-用户1"', '"主辅部门-用户6"', '"设计部-用户2"', '"销售部-用户5"'],
                          ['', '', '', '', '', ''])
        self.title4 = 'case4按用户1按季度查看1 2 3季度合同回款金额'
        ...
        self.title5 = 'case5按用户1按季度查看4 5 6季度合同回款金额'
        ...
        self.title6 = 'case6按用户1按季度查看本年合同回款金额'
        self.expected6 = ((['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['34320.0', '34320.0', '102960.0', '68640.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['21600.0', '21600.0', '64800.0', '43200.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['1680.0', '1680.0', '5040.0', '3360.0']),
                          (['"2019一季度"', '"2019二季度"', '"2019三季度"', '"2019四季度"'],
                           ['1920.0', '1920.0', '5760.0', '3840.0'])
                          )
        self.title7 = 'case7按用户1按季度查看上半年合同回款金额'
        ...
        self.title8 = 'case8按用户1按季度查看下半年合同回款金额'
        ...
        self.title9 = 'case9按用户1按季度查看04--08合同回款金额'
        ...
        self.title10 = 'case10按用户1按季度查看 7 8 9合同回款金额'
        ...
        self.title11 = 'case11按用户1按季度查看10 11 12合同回款金额'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('contract_rank_quarter.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_contract_rank_quarter()
    # os.remove('contract_rank_quarter.txt')
    # 上月
