...
class result_product_category_count_month:
    def __init__(self):
        ...
        self.title1 = 'case1用户1按月查看1月产品分类销量'
        ...
        self.title2 = 'case2用户1按月查看3月产品分类销量'
        ...
        self.title3 = 'case3用户1按月查看上季度产品分类销量'
        self.expected3 = (['"设计部子部门-用户4"', '"产品部-用户3"', '"设计部-用户1"', '"主辅部门-用户6"', '"设计部-用户2"', '"销售部-用户5"'],
                          ['', '', '', '', '', ''])
        self.title4 = 'case4用户1按月查看1 2 3季度产品分类销量'
        ...
        self.title5 = 'case5用户1按月查看4 5 6季度产品分类销量'
        ...
        self.title6 = 'case6用户1按月查看本年产品分类销量'
        ...
        self.title7 = 'case7用户1按月查看上半年产品分类销量'
        ...
        self.title8 = 'case8用户1按月查看下半年产品分类销量'
        ...
        self.title9 = 'case9用户1按月查看04--08产品分类销量'
        ...
        self.title10 = 'case9用户1按月查看 7 8 9产品分类销量'
        ...
        self.title11 = 'case9用户1按月查看10 11 12产品分类销量'
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            print (test_result)
            if test_result== True:
                f = codecs.open('product_category_count_month.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_product_category_count_month()
    # os.remove('product_category_count_month.txt')
    # 上月
