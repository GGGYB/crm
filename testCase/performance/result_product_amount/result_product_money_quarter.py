...
class result_product_money_quarter:
    def __init__(self):
    ...
    def case_1(self,title,expected,data1,data2,dimension1):
        ...
        for i in range(4):
            ...
            # print (test_result)
            if test_result== True:
                f = codecs.open('product_money_quarter.txt', 'a', 'utf-8')
...
if __name__ == '__main__':
    _result_amount =result_product_money_quarter()
    # os.remove('product_money_quarter.txt')
    # 上月
